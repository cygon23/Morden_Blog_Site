...
const careerTools = [
  ...
  },
  {
    ...
    description:
      "Compare salaries across different roles, companies, and locations",
    icon: Calculator,
    category: "Salary",
    users: "35+",
    status: "free",
  },
  {
    ...
    description:
      "Evaluate your technical and soft skills with comprehensive tests",
    icon: Brain,
    category: "Skills",
    users: "25+",
    status: "premium",
  },
  {
    ...
    description:
      "Discover optimal career trajectories based on your background",
    icon: BarChart3,
  ...
  },
  {
    ...
    description:
      "Practice with AI-powered mock interviews for your target role",
    icon: Award,
    category: "Interview",
    users: "40+",
    status: "premium",
      ...
      <div className='container-custom py-12'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
            Accelerate your career with our suite of powerful tools designed to
            help you succeed
          </p>
        </div>
          ...
          <Card className='hero-gradient text-white border-0 overflow-hidden'>
            <CardHeader className='text-center'>
              ...
              <CardDescription className='text-white/80 text-lg'>
                Get detailed feedback on your resume with our AI-powered
                analysis tool
              </CardDescription>
            </CardHeader>
