-- Temporarily allow user_id to be nullable for sample data
ALTER TABLE public.blogs ALTER COLUMN user_id DROP NOT NULL;

-- Insert sample blog posts without user_id requirement
INSERT INTO public.blogs (title, excerpt, content, category, image_url, status, published_at, tags) VALUES
(
